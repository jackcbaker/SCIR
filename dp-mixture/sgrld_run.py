...
def main():
    ...
    parser.add_argument('--alpha0', type=float, default=0.001)
    parser.add_argument('--alpha', type=float, default=1.)
    parser.add_argument('--K', type=int, default=30)
    parser.add_argument('--n', type=int, default=1000)
    parser.add_argument('--h_theta', type=float, default=1e-3)
    parser.add_argument('--h_sgld', type=float, default=5e-3)
    ...
    sampler = SGLD(model, DP, kstar = args.K, h_theta = args.h_theta, 
            h_sgld = args.h_sgld, minibatch_size = args.n)
